		...
		<section id="main">
			<section class="content">
					...
					<div class="swipe-img">
						<div class="swiper-container">
							<div class="swiper-wrapper">
								<c:forEach var="cafeStoreImg" items="${cafeStoreImgList}"
									varStatus="status1">
					...
					<div class="panel_area">
							...
							<div class="tab-content" id="cakes-info-content">
								...
								<div class="info-block">
									...
									<div>
										<p>
											営業開始時間
											<c:out value="${cafeStoreInfo.cafeStoreOpenTime}" />
										</p>
										<p>
											営業終了時間
											<c:out value="${cafeStoreInfo.cafeStoreCloseTime}" />
										</p>
									</div>
								</div>
								<hr>
								<div class="info-block">
									...
									<div>
										<p>
											<c:out value="${cafeStoreInfo.cafeStorePhoneNum}" />
										</p>
									</div>
								</div>
							</div>
						...
						<div id="panel2" class="tab_panel">
							<div class="tab-content" id="cakes-menu-content">
								<c:forEach var="cafeStoreMenu" items="${cafeStoreMenuList}"
									varStatus="status2">
									<div class="menu-block">
										<img class="menu-img"
											src="images/<c:out value="${cafeStoreMenu.cafeMenuImgUrl}" />"
											alt="カフェメニュー">
										<div class="cafe-menu-text-container">
											<div class="menu-item-name">
												<h3>
													<c:out value="${cafeStoreMenu.cafeMenuName}" />
												</h3>
											</div>
											<div class="menu-item-price">
												<p>
													¥
													<c:out value="${cafeStoreMenu.cafeMenuPrice}" />
												</p>
											</div>
										</div>
									</div>
				...
				<form action="CakeCafeConfirmServlet" method="POST">
					<div class="btn-fixed">
						<input type="hidden" name="selectedCafeStoreId"
							value="<c:out value="${cafeStoreInfo.cafeStoreId}"/>"> <input
							type="hidden" name="selectedCafeStoreName"
							value="<c:out value="${cafeStoreInfo.cafeStoreName}"/>">
						<input type="submit" class="submit-button" value="注文確認画面へ進む">
					</div>
				</form>
			</section>
		</section>
