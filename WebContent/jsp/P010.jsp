                    ...
                    <div class="content-block">
                        <div class="confirm-box">
                            ...
                            <div class="confirm-container confirm-container-cakes">
                                <div class="confirm-img-container"><img class="popular-suggest-img" src="images/<c:out value="${cakeStoreInfo.cakeStorePrimaryImg}" />" alt=""></div>
                                <div class="confirm-text-container">
                                    <h3><c:out value="${cakeStoreInfo.cakeStoreName}" /></h3>
                                    <form action="CakeStoreMapViewServlet" method="POST">
	                                    <div class="button-block">
	                                    	<input type="hidden" name="cakeStoreArea" value="<c:out value="${cakeStoreInfo.cakeStoreStation}" />">
                            ...
                            <div class="confirm-container confirm-container-cafe">
                                <div class="confirm-img-container"><img class="popular-suggest-img" src="images/<c:out value="${cafeStoreInfo.cafeStorePrimaryImg}" />" alt=""></div>
                                <div class="confirm-text-container">
                                    <h3><c:out value="${cafeStoreInfo.cafeStoreName}" /></h3>
                                    <form action="TicketServlet" method="POST" id="ticketCreateForm">
	                                    <div class="cafe-order-number">
	                                    	<input type="hidden" name="cakeStoreName" value="<c:out value="${cakeStoreInfo.cakeStoreName}" />">
	                                    	<input type="hidden" name="cafeStoreName" value="<c:out value="${cafeStoreInfo.cafeStoreName}" />">
                        ...
                        <div class="button-block">
                            <input class="submit-button" type="submit" value="確定する" form="ticketCreateForm">
                        </div>
                    </div>
                </section>
            </section>
