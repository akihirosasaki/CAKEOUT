...
public class PopularCakeStoreServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		String searchErea = req.getParameter("searchErea");
		...
		popularCakeStoreSearchModel pcsm = new popularCakeStoreSearchModel();
		 try {
			 popularCakeStores = pcsm.businessMethod(searchErea);
			 System.out.println(popularCakeStores);
		...
		session.setAttribute("searchErea",searchErea);
