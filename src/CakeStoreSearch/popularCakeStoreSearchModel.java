...
public class popularCakeStoreSearchModel {
	public ArrayList<CakeStoreVo> businessMethod(String searchErea) throws SQLException, NamingException {
		//		問い合わせ開始
		...
		try (Connection conn = cakeStoreDao.connect()) {
			popularCakeStores = cakeStoreDao.selectPopularCakeStore(conn, searchErea);
		}
